            ...
            >
              <div className="grid md:grid-cols-12 gap-4 md:gap-8 items-center">
                ...
                <div className="md:col-span-10">
                  <div className="gradient-subtle p-6 md:p-8 rounded-3xl shadow-soft relative overflow-hidden card-hover group">
                    <div className="absolute top-0 right-0 w-32 h-32 md:w-40 md:h-40 bg-primary/3 rounded-full blur-3xl" />
                    <div className="relative">
                      <div className="flex items-start gap-3 md:gap-4">
                        <CheckCircle2 className="w-5 h-5 md:w-6 md:h-6 text-primary flex-shrink-0 mt-1 icon-hover" />
                        <div>
